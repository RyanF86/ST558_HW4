...
parsed$articles # this is the data frame with information for the articles
...
CoasterDataCleaned |>
  ...
  tab_header(
    ...
    subtitle = "Mean and SD for all Roller Coasters"
  )
```
...
CoasterDataCleaned |>
  ...
  tab_header(
    title = "Top Speed and Max Height",
    subtitle = "Mean and SD for Extreme Roller Coasters"
  )
```
...
CoasterDataCleaned |>
  ...
  gt() |>
  tab_header(
    title = "Length and Duration Mean and SD",
...
CoasterDataCleaned |>
  ...
  gt() |>
  tab_header(
    title = "Drop and Number of Inversions Mean and SD",
...
- Create a relating Drop and MaxHeight by Scale and facet by Type
